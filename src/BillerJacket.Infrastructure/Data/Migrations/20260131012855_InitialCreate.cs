    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdempotencyKeyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DunningPlans", x => x.DunningPlanId);
                    table.ForeignKey(
                        name: "FK_DunningPlans_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "TenantId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DunningStepId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DunningPlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DunningSteps", x => x.DunningStepId);
                    table.ForeignKey(
                        name: "FK_DunningSteps_DunningPlans_DunningPlanId",
                        column: x => x.DunningPlanId,
                        principalTable: "DunningPlans",
                        principalColumn: "DunningPlanId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CustomerId");
                    table.ForeignKey(
                        name: "FK_CommunicationLogs_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceDunningStates", x => x.InvoiceId);
                    table.ForeignKey(
                        name: "FK_InvoiceDunningStates_DunningPlans_DunningPlanId",
                        column: x => x.DunningPlanId,
                        principalTable: "DunningPlans",
                        principalColumn: "DunningPlanId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceDunningStates_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "InvoiceId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunicationLogs_InvoiceId",
                table: "CommunicationLogs",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunicationLogs_TenantId_InvoiceId",
                table: "CommunicationLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DunningPlans_TenantId",
                table: "DunningPlans",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_DunningSteps_DunningPlanId_StepNumber",
                table: "DunningSteps",
                columns: new[] { "DunningPlanId", "StepNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyKeys_TenantId_Operation_KeyValue",
                table: "IdempotencyKeys",
                columns: new[] { "TenantId", "Operation", "KeyValue" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDunningStates_DunningPlanId",
                table: "InvoiceDunningStates",
                column: "DunningPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebhookEvents_TenantId_Provider_ExternalEventId",
                table: "WebhookEvents",
